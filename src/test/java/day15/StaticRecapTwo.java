...
public class StaticRecapTwo {
	...
	public static void getInfo() {
		...
		//TODO print value of variable [totalAmount]
			System.out.println(StaticRecapOne.totalAmount); // printing static variable from different class --> className.variableName
	...
	public static void main(String[] args) {
		...
		//TODO call method [getInfo()]
			getInfo(); //since we are getting static method from the same class we can just call it by methodName
...
/**
	the question i have is this, why we are cresting object under getInfo method instead of main method.
*/